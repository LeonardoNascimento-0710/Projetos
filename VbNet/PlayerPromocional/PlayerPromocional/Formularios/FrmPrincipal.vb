...
#Region "Configuração"
    ...
    Private ReadOnly caminhoAudioPromocao As String =
    IO.Path.Combine(
        pastaPiper,
        "promocao.wav")

    Private ReadOnly caminhoTextoPromocaoPiper As String =
    IO.Path.Combine(
        pastaPiper,
        "promocao.txt")

    Private Const modeloVozPiper As String =
    "pt_BR-cadu-medium"

    Private textoAudioPiperGerado As String = ""
...
#Region "botões"
    ...
    e As EventArgs
        ...
        Try
            ...
            Dim textoPromocao As String =
            TxtPromocao.Text.Trim()

            If textoPromocao = "" Then

                MessageBox.Show(
                "Digite o texto da promoção.",
                "Promoção vazia",
                MessageBoxButtons.OK,
                MessageBoxIcon.Warning)
            ...
            Dim audioGerado As Boolean =
            Await GerarAudioPromocaoPiperAsync(
                textoPromocao)

            If Not audioGerado Then
...
#Region "Funções"
    ...
    proximoIndice As Integer)
        ...
        Try
            ...
            ReproduzirAudioPromocao(caminhoAudioPromocao, True, False, proximoIndice)
...
.AnunciosGravadosAleatorios =
    anunciosGravadosAleatorios,
            ...
            .TextoPromocao = TxtPromocao.Text,
    ...
    texto As String
        ...
        If IO.File.Exists(caminhoAudioPromocao) AndAlso
   IO.File.Exists(caminhoTextoPromocaoPiper) Then

            Dim textoSalvo As String =
        IO.File.ReadAllText(
            caminhoTextoPromocaoPiper)
        ...
        Try
            ...
            If IO.File.Exists(caminhoAudioPromocao) Then
            ...
            informacoes.ArgumentList.Add("-m")
            informacoes.ArgumentList.Add(modeloVozPiper)

            informacoes.ArgumentList.Add("-f")
            informacoes.ArgumentList.Add(caminhoAudioPromocao)
            ...
            Using processo As New Process()
               ...
               Not IO.File.Exists(caminhoAudioPromocao) Then
